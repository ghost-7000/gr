-- GRMC Comprehensive Products Fix
-- This script ensures all 12 legacy products are present in the database
...
('PNT-BRN-MAT-010', 'صبغ بني مطفي فاخر', 'طلاء داخلي بلون بني مطفي دافئ وأنيق، مثالي لإضفاء إحساس بالثبات والدفء.', 3.00, 6.50, 'c1 (4).jpeg', 'أصباغ داخلية', 100),
